...
import "./toolbar.css";
import lcdTexture from "../assets/lcd-texture.webp";
        ...
        >
            <div className="relative w-64 h-5.5 overflow-hidden rounded-xs">
                <div className={"flex flex-row gap-2 absolute right-2 top-0.5 z-20 items-center justify-center"}>
                    <button onClick={() => navigate(-1)}
                            className={"text-[#87ACC8] glowText text-xs scale-y-150 cursor-pointer"}>&lt;</button>
                    <button onClick={() => navigate(1)}
                            className={"text-[#87ACC8] glowText text-xs scale-y-150 cursor-pointer"}>&gt;</button>
                </div>
                <img
            ...
            <div className={"flex flex-row gap-2 items-center"}>
                <div className={"relative w-9 h-4 rounded overflow-hidden"}>
                    <p
                        className={`${gate ? "glowText" : "glowTextBlack"} text-[8px] absolute z-30 top-0.5 right-1.75`}
                        style={{
                            color: gate ? "#001B35" : "#87ACC8",
                    ...
                    <div
                        ...
                        style={{
                            backgroundColor: gate ? "#5A6FA8" : "#2F3767",
                            transition: "background-color 0.25s ease",
                        }}
                    />
                </div>
                <ModeButton label="" value={gate} onClick={onGateToggle}/>
                <div className={"relative w-9 h-4 rounded overflow-hidden"}>
                    <p
