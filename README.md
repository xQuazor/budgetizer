...
- [ ] Cross-platform builds (Windows VST3, AU for macOS)
- [ ] Preset system (save/load effect configurations)
- [ ] More modulation sources (envelope followers, MIDI learn)
- [ ] GPU-accelerated processing for real-time visualization
...
Found a bug or want to improve something? Contributions are welcome! Please:
